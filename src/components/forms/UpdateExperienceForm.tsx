...
import { ExperienceFormValues } from "./CreateExperienceForm";
import { z } from "zod";
...
type UpdateExperienceForm = ExperienceFormValues & onSubmit

export default function UpdateExperienceForm(props: UpdateExperienceForm) {
